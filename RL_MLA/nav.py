...
class MavlinkController:
    ...
    def arm(self, arm: bool = True):
        return # PLEASE DO NOT ARM THE DRONE WITH CODE
...
def main():
    ...
    ap.add_argument("--rate_hz", type=float, default=100.0, help="command rate")
    ...
    ap.add_argument("--log_images", action="store_true", help="Log concatenated depth+RGB images with navigation arrows")
    ap.add_argument("--output_folder", default="logged_images", help="Folder to save logged images")
    args = ap.parse_args()
